...
public class UIController : MonoBehaviour
{
    ...
    public void btnRestartTutorialFindKey()
    {
        SceneMove(KeyStore.tutorialFindKeyGame);
    }

    public void btnRestartTutorialFindRoad()
    {
        SceneMove(KeyStore.tutorialFindRoadGame);
    }
